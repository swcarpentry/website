...
CONTROLS = (
    ...
    ('swcarpentry/shell-novice-es', 'Unix Shell - Español'),
    ('swcarpentry/git-novice-es', 'Git - Español'),    
    ...
    ('swcarpentry/r-novice-gapminder', 'R (Gapminder Data - Español)'),
    ('swcarpentry/r-novice-gapminder-es', 'R (Gapminder Data)'),
