...
for the same reason that PhD committees always include external examiners.
...
4.  We need to set a time limit on completion,
...
5.  We need to follow up with the teams who took part in December 2015's training
